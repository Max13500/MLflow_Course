...
def get_run_env_file(experiment_name="Apple_Models", 
    ...
    python_env_src = mlflow.artifacts.download_artifacts(run_id=run_id,artifact_path="rf_apples/python_env.yaml")
    ...
    conda_src = mlflow.artifacts.download_artifacts(run_id=run_id,artifact_path="rf_apples/conda.yaml")
    ...
    requirements_src = mlflow.artifacts.download_artifacts(run_id=run_id,artifact_path="rf_apples/requirements.txt")
